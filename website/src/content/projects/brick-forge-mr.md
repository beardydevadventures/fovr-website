---
title: Brick Forge MR
tagline: Mixed reality building instructions for playful hands-on assembly.
excerpt: A Meta Quest Presence Platform prototype that displays step-by-step 3D building instructions in passthrough using spatial anchoring and hand tracking.
category: FoVR Labs
status: Prototype
highlight: false
order: 11
...
links:
  - label: Devpost
    href: https://devpost.com/software/brick-forge
    icon: tabler:trophy
    external: true
---
